...
// In production (Firebase Hosting), window.NOTELET_API_URL is set by public/js/config.js
// In local dev, Express at port 3030 proxies /api/* so empty string works fine
declare const NOTELET_API_URL: string | undefined;
const API_BASE_URL: string =
  typeof NOTELET_API_URL !== 'undefined' && NOTELET_API_URL ? NOTELET_API_URL : '';
